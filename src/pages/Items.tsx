...
import { Scan, Lock, Sparkles, Loader2 } from "lucide-react";
...
export default function Items() {
  ...
  const handleBarcodeClick = () => {
    // Check if user has access to barcode scanning
  ...
  const handleBarcodeScanned = async (decodedText: string) => {
    ...
    if (!isValidBarcode(decodedText)) {
      toast({
        ...
        description:
          "The scanned barcode format is not recognized. Please enter details manually.",
        variant: "destructive",
      });
                  ...
                  <div className="space-y-2">
                    ...
                    <HsnCodeSelector
                      ...
                      onSelect={(hsnCode, gstRate) => {
                        setHsnGstRate(gstRate.igst);
                        setFormData({
                          ...formData,
                          hsn_sac_code: hsnCode,
                          gst_rate: gstRate.igst,
                        });
                      }}
                    />
